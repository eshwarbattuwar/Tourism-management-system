...
Route::get('place/bookingForm/{id}', [BookingController::class, 'showPlaceBookingForm'])->name('place.bookingForm');
Route::post('place/storeBooking/{id}', [BookingController::class, 'storePlaceBooking'])->name('place.storeBooking');
