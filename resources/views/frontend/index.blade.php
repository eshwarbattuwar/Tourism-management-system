                    ...
                    <div class="slider-container">
                        <div class="slide">
                            @foreach ($topDestinations as $destination)
                                <div class="item"
                                    style="background-image: url({{ $destination->imageURL ? asset('frontend/images/' . $destination->imageURL) : '' }});">
                                    <div class="content">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="section-title mb-6 w-75 mx-auto text-center">
                    ...
                    <p>These destination are one of the best But you can get them a lowest price possible...choose your destination and book it..</p>
                </div>
                <a href="{{ route('bestDestination.tour') }}" class="btn btn-light-green rounded-pill text-white" style="color: #029e9d;">See All</a>
            </div>
            <div class="row">
                @foreach ($topOffers as $place)
    ...
    <section class="trending pb-0 pt-4">
        <div class="container">
            <div class="section-title mb-6 w-75 mx-auto text-center">
                ...
                <a href="{{ route('generalDestination.tour') }}" class="btn btn-light-green rounded-pill text-white" style="color: #029e9d;">See All</a>
            </div>
            <div class="row">
                @foreach ($generalDestinations as $place)
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card h-100 shadow border-0 rounded">
                            <div class="card-img-top position-relative" style="height: 220px; overflow: hidden;">
                                <img src="{{ asset('frontend/images/' . $place->imageURL) }}" alt="{{ $place->name }}" class="w-100 h-100 object-fit-cover">
